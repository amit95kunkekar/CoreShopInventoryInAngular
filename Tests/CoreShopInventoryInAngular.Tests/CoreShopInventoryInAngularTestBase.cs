...
namespace CoreShopInventoryInAngular.Tests
{
    public abstract class CoreShopInventoryInAngularTestBase : AbpIntegratedTestBase<CoreShopInventoryInAngularTestModule>
    {
        private DbConnection _hostDb;
        private Dictionary<int, DbConnection> _tenantDbs; //only used for db per tenant architecture

        protected CoreShopInventoryInAngularTestBase()
        {
        ...
        protected void UsingDbContext(Action<CoreShopInventoryInAngularDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Func<CoreShopInventoryInAngularDbContext, Task> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected T UsingDbContext<T>(Func<CoreShopInventoryInAngularDbContext, T> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<T> UsingDbContextAsync<T>(Func<CoreShopInventoryInAngularDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<CoreShopInventoryInAngularDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<CoreShopInventoryInAngularDbContext>())
                {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<CoreShopInventoryInAngularDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<CoreShopInventoryInAngularDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<CoreShopInventoryInAngularDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<CoreShopInventoryInAngularDbContext, Task<T>> func)
        {
            T result;
